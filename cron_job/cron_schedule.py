...
cron = CronJob()
cron.add_every_minute(minutes=5, command='/Library/Frameworks/Python.framework/Versions/3.6/bin/python3 /Users/irinanazarchuk/Documents/code/python/crawler_docker/crawler-python/parser/run.py', comment='parser')
